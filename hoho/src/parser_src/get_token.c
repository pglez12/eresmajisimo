...
/*   Updated: 2024/05/24 11:51:27 by ancarvaj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"
/*
* automata_get_token populates the list t_token
*/
...
/*
* ft_get_token returns the type of token depending on the giving string
*/
...
/*
* red_type returns an int depending on the given token
*/
...
/*
* count_red calculates how many files are in the command
*/
